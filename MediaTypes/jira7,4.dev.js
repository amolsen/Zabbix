...
Jira.prototype.onUpdate = function (alert, dontUpdatePriority) {
    ...
    var TicketTransitions = this.sendRequest('GET', '/rest/api/latest/issue/' + encodeURIComponent(jira_issue_key) + '/transitions');
	const resolvedItem = TicketTransitions.transitions.find(item =>
